...
| `agr1` / `agr2` | Agricultural commodity indices |
| `intrt_rts` | Interest rate instruments |
| `petrol_plus` | Oil, gas, and energy sector indices |
...
![Table 1.1: COVID Data vs. Economic Indicators Top 10 Scores (Full Period)](econ_anlys_fnd_opt_cndsTable11CovidDatavsEconomicIndicatorsTop10ScoresFullPeriod.png)
