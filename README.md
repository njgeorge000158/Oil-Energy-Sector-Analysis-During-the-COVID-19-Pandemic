...
The Adaptation period is the longest and most structurally complex of the four phases and encompasses many events: the Emergency Use Authorization of the first COVID vaccines in December 2020; the accelerating vaccine rollout through spring 2021; a broad commodity supercycle that drove the Bloomberg Commodity Index to multi-year highs by mid-2021; the Delta variant resurgence in summer 2021; and the onset of global supply chain disruption. Critically, by the start of this phase, JUne 2020, markets had learned to price pandemic risk as a persistent background condition rather than as an acute crisis. The COVID signal was no longer the primary market driver but remained as one factor among many.

#### Why Deaths Rather Than Cases

The shift from rolling, cumulative `covid_c&d` (Initial Shock) to `covid_deaths` (Adaptation) as the dominant COVID x-variable reflects a meaningful change in the informational structure of the pandemic. By mid-2020, case counts had become a noisy signal subject to testing capacity constraints and reporting backlogs. Cumulative Covid fatality counts, smoothed via a 7-day rolling average, provides a more reliable and actionable measure of pandemic severity that investors and policymakers used to calibrate economic risk. The candidate selection analysis confirms this practice: `covid_deaths` appears in 7 of the top 10 rows in both the Adaptation levels and percentage-change analyses.

#### Why Metals as the Dominant Y-Variable

The Adaptation period brought the emergence of COVID's supply-side economic channel. While the Initial Shock operated primarily through demand destruction and risk sentiment, the Adaptation period introduced supply chain disruption as an increasingly important mechanism. Mining operations, smelting capacity, and logistics chains were disrupted by ongoing pandemic conditions, directly constraining metal supply. Simultaneously, fiscal stimulus-driven infrastructure spending and emerging electric vehicle battery demand created new structural demand for industrial metals (copper, nickel, cobalt, etc.). The COVID death-rate captures both the severity of ongoing disruptions and the market's reassessment of the pandemic's long-term economic footprint, making metals the most COVID-sensitive indicator category during this phase.
