...
There are two patterns that are immediately evident in this table. First, the score progression confirms a systematic causal decay: **66.06 → 56.60 → 55.67 → 51.81** across Initial Shock, Adaptation, Recovery, and Full Period respectively. COVID's causal footprint on economic indicators was strongest during the acute crash and attenuated progressively as the pandemic normalized. Second, the Y-side leadership transitions cleanly through three distinct asset classes — equities during the shock, metals through the middle phases, and exchange rates as the most durable full-period relationship — a finding with direct implications for understanding which market mechanisms transmitted pandemic information to prices at each stage of the crisis.
